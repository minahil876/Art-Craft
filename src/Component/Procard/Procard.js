...
//   useEffect(() => {
//     axios.get("http://192.168.12.108:8002/crafters/products/").then((res) => {
//       console.log(res.data);
//       setProduct(res.data);
//     },[]);

//     if (data) {
//       axios.get(`http://192.168.12.108:8002/crafters/favorites/${data.id}/`, {
//         headers: {
//           'Authorization': `Bearer ${token}`
//         }
//       }).then((res) => {
...
//         price: item.price,
//       };
//       axios.post(`http://192.168.12.108:8002/crafters/add-to-cart/${user_id}/${product_id}/`, body, {
//         headers: {
//           'Authorization': `Bearer ${token}`
//         }
//       }).then((res) => {
...
//         price: item.price,
//       };
//       axios.post(`http://192.168.12.108:8002/crafters/favorites/${product_id}/`, body, {
//         headers: {
//           'Authorization': `Bearer ${token}`
//         }
//       }).then((res) => {

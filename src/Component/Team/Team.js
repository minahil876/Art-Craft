        ...
        <div className="row2">
          <div className="col-md-4 m-2 col-sm-6">
            <div className="box2">
              ...
              <div className="box-content">
                <h4 className="title" style={{color: 'white'}}>Minahil Iqbal</h4>
                <p className="description">
                  <strong style={{marginLeft: '30%'}}>Phone:</strong> +92 35642315<br />
                  <strong style={{marginLeft: '30%'}}>Email:</strong> Minahil@gmail.com
                </p>
          ...
          <div className="col-md-4  m-2 col-sm-6">
            <div className="box2">
              ...
              <div className="box-content">
                <h4 className="title" style={{color: 'white'}}>Aqeera Arshad</h4>
                <p className="description">
                  <strong style={{marginLeft: '30%'}}>Phone:</strong> +92 35642315<br />
                  <strong style={{marginLeft: '30%'}}>Email:</strong> Aqeera@gmail.com
                </p>
                <div className="social-icons">
                  <a href="https://www.facebook.com"><FontAwesomeIcon icon={faFacebook} /></a>
                  <a href="https://www.twitter.com"><FontAwesomeIcon icon={faTwitter} /></a>
          ...
          <div className="col-md-4 m-2 col-sm-6">
            <div className="box2">
              ...
              <div className="box-content">
                <h4 className="title" style={{color: 'white'}}>Fatima Butt</h4>
                <p className="description">
                  <strong style={{marginLeft: '30%'}}>Phone:</strong> +92 35642315<br />
                  <strong style={{marginLeft: '30%'}}>Email:</strong> Fatima@gmail.com
                </p>
                <div className="social-icons">
                  <a href="https://www.facebook.com"><FontAwesomeIcon icon={faFacebook} /></a>
                  <a href="https://www.twitter.com"><FontAwesomeIcon icon={faTwitter} /></a>
